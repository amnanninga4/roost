#!/usr/bin/env bash
# Writes ~/claude-reports/roost-now.md: the plain-language answer to "what is going on with Roost".
#
...
#
# Stable filename on purpose. Deliverables get a date suffix; this is a dashboard you re-read, so it
# keeps one path you can bookmark. The generated-at stamp at the top is how you know it is fresh.
set -uo pipefail

OUT="$HOME/claude-reports/roost-now.md"
