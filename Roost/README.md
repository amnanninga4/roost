...
| `paired` | paired as Anne: ten daily chores, the whole escalation ladder, one of each handoff state, four shopping rows, two wishlist rows, four meals, two projects |
