...
Roost/
  ...
  Sources/
    ...
    Models/Records.swift      SwiftData models: ChoreRecord (season, together, weekdays, dueDay), CompletionRecord, SyncState (and the schema list)
